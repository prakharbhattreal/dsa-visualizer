"use client";
import { BrainCircuit, CircuitBoard, Github,   Menu } from "lucide-react";
...
export const Navbar = () => {
  ...
  return (
    <header className="shadow-inner bg-opacity-15 w-full md:w-[70%] top-5 mx-auto sticky border border-secondary z-40 flex justify-between items-center p-2 backdrop-blur-md">
